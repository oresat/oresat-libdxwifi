...
// The Radiotap header it_present field IS aligned, however the compiler doesn't
// think it is since the struct is packed. Pragma ignores warning for this 
// specific file. 
...
static const struct ieee80211_radiotap_namespace radiotap_ns = {
    .n_bits = NELEMS(rtap_namespace_sizes),
    ...
    size_t max_length, const struct ieee80211_radiotap_vendor_namespaces *vns)
{
    ...
    if (max_length < sizeof(ieee80211_radiotap_hdr))
        return -EINVAL;
